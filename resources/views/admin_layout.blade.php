...
<body>
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            <span class="username">Phạm Đức</span>
                            <b class="caret"></b>
                        </a>
                ...
                <div class="leftside-navigation">
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            ...
                            <ul class="sub">
                                <li><a href="typography.html">Thêm danh muc</a></li>
    ...
    <script src="public/backend/jquery.dcjqaccordion.2.7.js"></script>
    <script src="public/backend/js/public/backend/.js"></script>
